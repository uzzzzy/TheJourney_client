...
export default function CardJourney({ item, user, setModal }) {
    ...
    return (
        <div className=" bg-white group relative rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform duration-200 cursor-pointer flex flex-col" onClick={handleClick}>
            <img src={getImg(item.description)} alt="journey" className="hover:animate-pulse w-full h-60 md:h-60 object-center object-cover rounded-lg" />
            ...
            <div className="px-3 py-4 bg-gradient-to-r from-blue-500 h-60 -mt-60 md:mt-0 md:from-transparent">
