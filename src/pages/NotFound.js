...
export default function NotFound() {
    return (
        <div className="h-screen w-screen flex justify-center -mt-24 md:-mt-32 overflow-hidden">
            <div className="container flex mt-4 md:mt-0 flex-col md:flex-row items-center justify-center px-5 text-gray-700">
